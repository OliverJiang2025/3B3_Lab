...
$L_3 = \frac{30 \times 0.53 \times (1-0.53)}{100000 \times 0.346} = 217.6 \mu H$.
$L_2 // L_3 = \frac{L_2 L_3}{L_2 + L_3} = \frac{30 \times 0.53 \times (1-0.53)}{100000 \times 0.222} = 339.9 \mu H$.
We can get $L_2 = 567.8 \mu H$ from above two equations.

For the last case in Figure \ref{fig:2-3}, the buck converter now operates in DCM.
Thus, the previous formula is not applicable.
